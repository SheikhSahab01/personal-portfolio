    ...
    return (
        <motion.div className="group relative flex cursor-pointer">
            ...
            className="flex items-center justify-center  rounded-full p-1 border border-[#333333] object-contain w-16 h-16 xl:w-20 xl:h-20
                ...
                <motion.div className="rounded-full w-14 h-14 xl:w-18 xl:h-18 relative overflow-hidden">
                    <Image src={urlFor(props.oneskill?.projectImage).url()} alt="skill" fill className="object-cover" unoptimized />
                </motion.div>
            </motion.div>
