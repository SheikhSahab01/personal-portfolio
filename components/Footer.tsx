        ...
        <Link href="#hero" >
            <footer className="sticky bottom-5 w-fit mx-auto  ">
                <div className="group flex items-center justify-center flex-col">
                    ...
                    <motion.img className="w-9 h-9 rounded-full object-cover object-top filter grayscale group-hover:grayscale-0 animate-bounce"  src={urlFor(pageInfo.heroImage).url()} alt="personal_image" />
                </div>
            </footer>
        </Link>
    )
