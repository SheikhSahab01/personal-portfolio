...
const ExperienceCard = ({oneexperience}: Props) => {
  return (
    <article className="bg-white dark:bg-[#222] p-6 md:p-10 snap-center flex flex-col items-center justify-start rounded-lg space-y-3 flex-shrink-0 w-[300px] md:w-[400px] xl:w-[600px] shadow-md border border-gray-200 dark:border-gray-700 transition-all duration-200 hover:scale-105 hover:shadow-2xl hover:border-primary/40">
        ...
        <div className="px-0">
            <h4 className="text-3xl font-light text-black dark:text-white">{oneexperience.jobTitle}</h4>
            <p className="font-bold text-xl mt-1 text-black dark:text-white">{oneexperience.company}</p>
            ...
            <p className="text-sm uppercase text-gray-500 dark:text-gray-400 pb-2 ">{oneexperience.dateStarted}
